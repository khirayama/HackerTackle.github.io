    ...
    EN: {
        ...
        presentations: [
            ...
            },
            {
                ...
                presentation_info: "Are you using or developing containers etc...? Due to the surge in operation automation or Infrastracture as Code, Linux container has been garnering a lot of attention from various contexts. \nThe keywords related to such containers start with LXC, followed by Docker, runc, Kubernetes, OCI, CRI-O, and finally extending to as far as various cloud services. \nAt this point, there are too many containers to keep track of. \nIn this session, I am going to provide a comprehensive picture of container technologies to those who think they have been left behind in the rapid currents of technological transformation, and those who tried the container but failed to understand its fundamental principles. \nOn top of that, as an example of utilization of containers other than Kubernetes, I would like to introduce my product 'Haconiwa' and talk about what we can do with this product, and what we are doing with it.",
